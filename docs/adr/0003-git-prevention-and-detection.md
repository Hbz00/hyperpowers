...
then probed with adversarial inputs *outside* the table. It now holds **278** cases, having grown
...
from 171 cases to 278, and every case added after the first draft is a defect that shipped. The
